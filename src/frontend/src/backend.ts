...
export class Backend implements backendInterface {
    ...
    async getFavorites(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
    ...
    async getMultipleStocks(arg0: Array<string>, arg1: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMultipleStocks(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPriceQuote(arg0: string): Promise<PriceQuote> {
        if (this.processError) {
            try {
                const result = await this.actor.getPriceQuote(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStockData(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getStockData(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
